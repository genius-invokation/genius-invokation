...
const deck1: DeckConfig = {
  characters: [1213, 1201, 1608],
  cards: [
    322001, 322002, 322003, 322004, 332029,
    // 116081, 116081, 332031, 311105, 332037,
    311110, 311205, 312023, 312023, 312031, 312031, 321004, 321004, 321024,
