      ...
      <g filter="url(#filter0_ddd_48_508)">
        ...
        <g mask="url(#mask0_48_508)">
          ...
          <path 
            ...
            fill="#F5E09E"
          />
          <line x1="255" y1="88" x2="255" y2="423" stroke="#CC8C44" stroke-width="8"/>
          <line x1="110.938" y1="171.282" x2="401.057" y2="338.782" stroke="#CC8C44" stroke-width="8"/>
          <line x1="399.057" y1="172.218" x2="108.938" y2="339.718" stroke="#CC8C44" stroke-width="8"/>
          <mask 
            id="mask1_48_508" 
            style={{"mask-type":"alpha"}} 
            maskUnits="userSpaceOnUse" 
          ...
          <g mask="url(#mask1_48_508)">
            <circle cx="399.5" cy="375.5" r="103.5" stroke="#CC8C44" stroke-width="40"/>
          </g>
        </g>
        <path 
