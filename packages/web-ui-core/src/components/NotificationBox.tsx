...
export function NotificationBox(props: NotificationBoxProps) {
  ...
  return (
    <div
      class="absolute top-[calc(50%-170px)] z-100 h-15 min-w-60 data-[opp=false]:left-15 data-[opp=true]:right-15 text-white rounded-2 shadow-lg notification-box border-2 animate-[notification-box_700ms_both]"
      data-opp={props.opp}
      style={{
