  ...
  return (
    ...
    >
      <g filter="url(#filter0_ddd_24_174)">
        ...
        <path
          d="M254.127 19.6589C255.404 17.447 258.596 17.447 259.873 19.6589C274.5 38.6822 263.5 56.6822 309 84.6822H204.5C251 56.6822 240 38.6822 254.127 19.6589Z"
          fill="#7E4346"
        />
        <path
          d="M19.6589 258.555C17.447 257.278 17.447 254.086 19.6589 252.809C38.6822 238.182 56.6822 249.182 84.6822 203.682L84.6822 308.182C56.6822 261.682 38.6822 272.682 19.6589 258.555Z"
          fill="#7E4346"
        />
        <path
        ...
        />
        <path
          d="M61.7066 255.276C60.7645 255.82 60.7645 257.18 61.7066 257.724C73.462 270.5 80.962 273.5 95.5869 304L95.5869 208C81.462 238.5 72.962 242.5 61.7066 255.276Z"
          fill="#A35254"
        />
        <path
        ...
        />
        <path
          d="M255.276 60.7066C255.82 59.7645 257.18 59.7645 257.724 60.7066C270.5 72.462 273.5 79.962 304 94.5869H208C238.5 80.462 242.5 71.962 255.276 60.7066Z"
          fill="#A35254"
        />
        <circle
          cx="256.5"
        ...
        <rect
          ...
          height="62.1154"
          rx="4"
          transform="matrix(-0.707107 0.707107 0.707107 0.707107 239.395 236)"
          fill="#A6544E"
        />
      </g>
      <defs>
